...
/**
 * DELETE /api/bus/subscriptions/[id]
 * Cancel a student's bus subscription and drop the unpaid term charge.
 */
export async function DELETE(
  ...
  try {
    ...
    const { error } = await supabase.from("bus_subscriptions").delete().eq("id", id);
